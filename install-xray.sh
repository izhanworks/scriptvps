...
wget -q -O /usr/local/naikstore/xray-mini "https://raw.githubusercontent.com/nikstore/scriptvps/main/xray-mini"
...
# // Downloading Menu
wget -q -O /usr/bin/add-xray "https://raw.githubusercontent.com/nikstore/scriptvps/main/add-xray.sh"
wget -q -O /usr/bin/del-xray "https://raw.githubusercontent.com/nikstore/scriptvps/main/del-xray.sh"
wget -q -O /usr/bin/renew-xray "https://raw.githubusercontent.com/nikstore/scriptvps/main/renew-xray.sh"
